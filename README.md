...
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 🧠 **Ask the Archive**               | Natural-language chat over my own site — hybrid keyword + vector retrieval over 2,022 indexed chunks, a four-rung model fallback, running on free tiers                                       | Postgres · pgvector · Cloudflare Workers AI | [![Live](https://img.shields.io/badge/Live-4CAF50?style=flat-square&logo=cloudflare&logoColor=white)](https://sankettambare.in/ask) [![Dossier](https://img.shields.io/badge/Dossier-4CAF50?style=flat-square)](./docs/second-brain-overview.html) |
